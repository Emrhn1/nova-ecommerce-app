...
export default function CartPage() {
  ...
  const handleDecrement = (productId: string, title: string, currentQuantity: number) => {
    if (currentQuantity === 1) {
      setItemToRemove({ id: productId, title });
    } else {
  ...
  return (
    <>
                        ...
                        <Box sx={{ flexGrow: 1, minWidth: 0, width: '100%' }}>
                          <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                            ...
                            <IconButton
                              color="error"
                              size="small"
                              onClick={() => setItemToRemove({ id: product.id, title: product.title })}
                          ...
                          >
                            ...
                            >
                              <IconButton
                                size="small"
                                onClick={() => handleDecrement(product.id, product.title, quantity)}
                                sx={{ p: 0.75 }}
                              >
                                <Minus size={16} />
                              </IconButton>
      ...
      <CartConfirmModal
        ...
        description="Are you sure you want to remove all items from your shopping bag? This action cannot be undone."
      ...
      <CartConfirmModal
        open={!!itemToRemove}
        title="Remove Item?"
        description={`Are you sure you want to remove "${itemToRemove?.title}" from your shopping bag?`}
        confirmText="Remove"
        cancelText="Cancel"
        onConfirm={() => {
          if (itemToRemove) {
